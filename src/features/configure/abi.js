export const masterChefABI = [
		...
		},
		{
			...
			"outputs": [
				{
					"internalType": "contract ElevenToken",
					"name": "",
					"type": "address"
				}
			],
